...
var grammar = {
    ...
    {"name": "date", "symbols": ["day"], "postprocess": id},
    {"name": "date", "symbols": ["year"], "postprocess": id},
    {"name": "date", "symbols": ["month"], "postprocess": id},
    {"name": "date", "symbols": ["euroday"], "postprocess": id},
    {"name": "date", "symbols": ["slashdate"], "postprocess": id},
    {"name": "date", "symbols": ["isodate"], "postprocess": id},
    ...
    {"name": "day", "symbols": ["month_name", "__", "day_number", "day$ebnf$1", "__", "year_number", "day$ebnf$2", "day$ebnf$3"], "postprocess": constructDay},
    ...
    {"name": "euroday", "symbols": ["day_number", "__", "month_name", "__", "year_number", "euroday$ebnf$1", "euroday$ebnf$2"], "postprocess": constructEuroDate},
    ...
    {"name": "day_number$ebnf$2", "symbols": ["ordinal_suffix"], "postprocess": id},
    {"name": "day_number$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "day_number", "symbols": ["day_number$ebnf$1", /[0-9]/, "day_number$ebnf$2"], "postprocess": (d) => Number([d[0],d[1]].join(""))},
